...
function live_notifications_center(){
	...
	$('<div class="item"><img class="dashboard-avatar" alt="Lucas" src="/assets/railgun/optimus/avatar.jpg"><h4>Action1</h4><p>description1</p></div>')
...
function growlLikeNotifications() {
	...
	$('#add-sticky').click(function(){
		...
		var unique_id = $.gritter.add({
			...
			image: '/assets/railgun/optimus/avatar.jpg',
